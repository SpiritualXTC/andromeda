...
#include "Math/glm_conversion.h"
#include "Math/glm_extension.h"
#include "Math/glm_infinity.h"
...
namespace andromeda
{
	/*
		Region!
	*/
	template <typename T, glm::precision P = glm::precision::defaultp, template <typename, glm::precision> class V >
	struct Region
	{
		typedef V<T, P> TYPE;
		...
		*/
		template <typename _T, glm::precision _P = glm::precision::defaultp, template <typename, glm::precision> class _V >
	...
	//typedef Region<Float, glm::highp, glm::tvec1> Region1f;
	//typedef Region<Double, glm::highp, glm::tvec1> Region1d;
	//typedef Region<Int32, glm::highp, glm::tvec1> Region1i;



	/* 2D Typedef */
	typedef Region<Float, glm::highp, glm::tvec2> Region2f;
	typedef Region<Double, glm::highp, glm::tvec2> Region2d;
	typedef Region<Int32, glm::highp, glm::tvec2> Region2i;

	/* 3D Typedef */
	typedef Region<Float, glm::highp, glm::tvec3> Region3f;
	typedef Region<Double, glm::highp, glm::tvec3> Region3d;
	typedef Region<Int32, glm::highp, glm::tvec3> Region3i;

	/* 4D Typedef */
	typedef Region<Float, glm::highp, glm::tvec4> Region4f;
	typedef Region<Double, glm::highp, glm::tvec4> Region4d;
	typedef Region<Int32, glm::highp, glm::tvec4> Region4i;
}